...
function StlViewer(e, t) {
    ...
    this.set_on_model_mousedown = function(e) {
        ...
        o.onmousedown_callback && (o.parent_element.addEventListener("mousedown", o.onmousedown),
        o.parent_element.addEventListener("touchstart", o.onmousedown))
    }
    ,
    this.set_drag_and_drop = function(e) {
        e ? (o.parent_element.addEventListener("dragover", o.handleDragOver),
        o.parent_element.addEventListener("drop", o.handleFileDrop)) : (o.parent_element.removeEventListener("dragover", o.handleDragOver),
    ...
    this.set_options = function() {
        ...
        o.bg_color = o.get_opt("bgcolor", o.bg_color),
    ...
    this.load_model = function(e) {
        return o.max_model_id = Math.max(o.max_model_id, e.id),
        e.filename || e.local_file ? o.load_from_stl_file(e, !1) : e.mesh ? o.add_from_existing_mesh(e) : void o.models_count--
    }
    ,
    ...
    this.load_from_stl_file = function(e) {
        ...
        t.onmessage = function(a) {
            ...
            case o.MSGFROMWORKER_STL_LOADED:
                ...
                if (i) {
                    ...
                    o.is_ie || (s.side = THREE.DoubleSide),
                    e.display || (e.display = "flat"),
                    o.set_material_display(e.display, s, i),
                    e.mesh = new THREE.Mesh(i,s),
                    o.set_model_custom_props(e),
                    o.set_geo_minmax(e),
                    e.mesh.model_id = e.id,
                    o.recalc_dims(e),
                ...
                t.terminate(),
                t = void 0,
                o.pre_loaded_ab_files && e.filename && o.pre_loaded_ab_files[e.filename] && delete o.pre_loaded_ab_files[e.filename];
                break;
        ...
        e.bytes_total = 0;
        var a = null;
        o.pre_loaded_ab_files && e.filename && o.pre_loaded_ab_files[e.filename] && (a = o.pre_loaded_ab_files[e.filename]),
        t.postMessage({
    ...
    this.model_loaded = function(e) {
        ...
        Object.keys(o.loaded_models_arr).length >= o.models_count && (o.camera_state ? o.camera_state = null : o.set_zoom(),
        o.set_light(),
        o.load_session++,
    ...
    this.remove_model = function(e) {
        ...
        t && (delete o.models[o.models_ref[e]],
    ...
    this.get_camera_state = function() {
        ...
        return e.copy(o.camera.position),
        t.copy(o.camera.up),
    ...
    this.set_camera_state = function(e) {
        if (!o.camera)
            return null;
        if (!e)
            return o.model_error("set_camera_state - no state vector");
    ...
    this.set_camera = function(e, t, a) {
        t && (o.zoom = t),
        o.camera.position.set(o.is_empty(e) ? o.camera.position.x : e, o.is_empty(t) ? o.camera.position.y : t, o.zoom >= 0 ? o.zoom : Math.max(3 * o.maxx, 3 * o.maxy, 3.5 * o.maxz))
    }
    ,
    ...
    this.set_or_update_geo_edges = function(e, t, a) {
        if (t && !a || (e.edges && o.scene.remove(e.edges),
        e.edges = null,
        t)) {
            var i = !1;
            if (a = a || !1,
            !e.edges || a) {
                ...
                e.edges = new THREE.LineSegments(new THREE.EdgesGeometry(s),o.edges_material),
                i = !0
            }
    ...
    this.set_model_custom_props = function(e) {
        ...
        e.scaley = i,
        e.scalez = s,
        1 == a && 1 == i && 1 == s || o.scale_geo(e, a, i, s),
        e.view_edges && o.set_or_update_geo_edges(e, !0),
        e.opacity && this.set_material_opacity(e.mesh.material, e.opacity),
    ...
    this.set_scale = function(e, t, a, i) {
        ...
        if (s && s.mesh && s.mesh.geometry) {
            ...
            t && (s.scalex = Math.max(t, .01)),
            s.scaley = Math.max(a || t, .01),
            s.scalez = Math.max(i || t, .01),
            o.scale_geo(s, s.scalex / n, s.scaley / l, s.scalez / r),
            s.edges && o.set_or_update_geo_edges(s, !0, !0)
        }
    }
    ,
    ...
    this.update_mesh_color = function(e, t, o) {
        ...
        e.material.needsUpdate = !0) : e.traverse(function(e) {
            e.visible = !1
        }))
    }
    ,
    this.set_color = function(e, t) {
        ...
        var a = o.models[o.models_ref[e]];
        a && a.mesh && (t.length < 6 || ("#" != t.charAt(0) && (t = "#" + t),
        a.color = t,
    ...
    this.error_in_model = function(e) {
        ...
        if (!Number.isInteger(e.id))
            return o.model_error("invalid id");
        if (e.id < -1)
            return o.model_error("id must be positive");
        if (!e.filename && !e.mesh && !e.local_file) {
            if (!e.name)
                return o.model_error("missing filename or mesh");
            e.filename = e.name
        }
    ...
    this.set_display = function(e, t) {
        ...
        var a = o.models[o.models_ref[e]];
        a && (o.set_material_display(t, a.mesh.material, a.mesh.geometry),
        a.display = t,
    ...
    this.onmousedown = function(e) {
        ...
        case "touchstart":
            ...
            o.mouse.x = (t.pageX - o.parent_element.offsetLeft) / o.parent_element.clientWidth * 2 - 1,
            o.mouse.y = -(t.pageY - o.parent_element.offsetTop) / o.parent_element.clientHeight * 2 + 1;
            break;
        default:
        ...
        if (a.length > 0) {
            if (void 0 === a[0].object.model_id)
                return;
            o.onmousedown_callback && o.onmousedown_callback(a[0].object.model_id, e, a[0].distance)
        } else
            o.send_no_model_click_event && o.onmousedown_callback(null, e, 0)
    }
    ,
    ...
    this.set_position = function(e, t, a, i) {
        ...
        var s = o.models[o.models_ref[e]];
        s && s.mesh && (s.x = o.is_empty(t) ? s.x : t,
        s.y = o.is_empty(a) ? s.y : a,
        s.z = o.is_empty(i) ? s.z : i,
    ...
    this.set_rotation = function(e, t, a, i, s) {
        ...
        if (n) {
            var l = s ? 1 : 0;
            t && (n.rotationx = t + n.mesh.rotation.x * l,
            n.mesh.rotation.x = n.rotationx),
            a && (n.rotationy = a + n.mesh.rotation.y * l,
            n.mesh.rotation.y = n.rotationy),
            i && (n.rotationz = i + n.mesh.rotation.z * l,
            n.mesh.rotation.z = n.rotationz),
            n.mesh.updateMatrixWorld(),
            n.edges && o.set_or_update_geo_edges(n, !0)
        }
    }
    ,
    ...
    this.get_model_filename = function(e, t, a, i) {
        var s = null;
        return e.orig_url && !i ? s = decodeURIComponent(e.orig_url) : e.orig_filename ? s = e.orig_filename : e.temp_filename ? s = e.temp_filename : e.local_file ? e.local_file.name && (s = e.local_file.name) : e.filename && (e.filename instanceof File && (s = File.name),
        s = e.filename),
        !s && t ? "model_" + e.id + ".stl" : s ? (a && (s = o.basename(s)),
        s) : null
    }
    ,
    this.add_model = function(e, t) {
        if (Array.isArray(e))
            return o.add_models(e);
        if (!o.ready)
            return o.models_to_add.push(e),
        ...
        if (i)
            return i;
        -1 == e.id && (e.id = ++o.max_model_id),
        o.models.push(e);
        var s = o.models.indexOf(e);
        return t || void 0 === o.models_ref[e.id] && o.models_count++,
        o.models_ref[e.id] = s,
        o.load_model(e),
        o.status
    }
    ...
    this.calc_volume_and_area = function(e, t) {
        var o, a, i, s, n, l, r, d, _, c, m, u, f, h, p = e.faces.length, g = 0, y = 0;
        for (c = 0; c < p; c++)
            o = e.vertices[e.faces[c].a].x * t,
            s = e.vertices[e.faces[c].a].y * t,
            r = e.vertices[e.faces[c].a].z * t,
            a = e.vertices[e.faces[c].b].x * t,
            n = e.vertices[e.faces[c].b].y * t,
            d = e.vertices[e.faces[c].b].z * t,
            g += -(i = e.vertices[e.faces[c].c].x * t) * n * r + a * (l = e.vertices[e.faces[c].c].y * t) * r + i * s * d - o * l * d - a * s * (_ = e.vertices[e.faces[c].c].z * t) + o * n * _,
            h = ((m = e.vertices[e.faces[c].a].distanceTo(e.vertices[e.faces[c].b]) * t) + (u = e.vertices[e.faces[c].b].distanceTo(e.vertices[e.faces[c].c]) * t) + (f = e.vertices[e.faces[c].c].distanceTo(e.vertices[e.faces[c].a]) * t)) / 2,
            y += Math.sqrt(h * (h - m) * (h - u) * (h - f));
    ...
    this.get_vsj = function(e, t, a) {
        ...
        return Object.keys(o.models_ref).forEach(function(e) {
            ...
            if (a)
                ...
                l && (n.filename = l),
                s.local_file && (n.local_file = s.local_file)
            }
            s.x && (n.x = s.x),
            s.y && (n.y = s.y),
            s.z && (n.z = s.z),
            s.display && (n.display = s.display),
            s.colors && "#ffffff" == s.color || s.color && (n.color = s.color),
            s.units && (n.units = s.units),
            s.rotationx && (n.rotationx = s.rotationx),
            s.rotationy && (n.rotationy = s.rotationy),
            s.rotationz && (n.rotationz = s.rotationz),
            void 0 === s.scale || a || 1 != s.scale && (n.scale = s.scale),
            1 == s.scalex || a || (n.scalex = s.scalex),
            1 == s.scaley || a || (n.scaley = s.scaley),
            1 == s.scalez || a || (n.scalez = s.scalez),
            void 0 !== s.opacity && 1 != s.opacity && (n.opacity = s.opacity),
            s.view_edges && (n.view_edges = s.view_edges),
            s.animation && (n.animation = JSON.parse(JSON.stringify(s.animation)),
            delete n.animation.start_time,
            delete n.animation.last_time),
            i.models[o.models_ref[e]] = n
        }),
    ...
    this.download_vsj = function(e) {
        ...
        i.length < 1 && (i = "1"),
        window.navigator.msSaveOrOpenBlob ? window.navigator.msSaveBlob(t, i + ".vsj") : (a.download = i + ".vsj",
        a.click())
    }
    ,
    this.load_vsj = function(e) {
        if (!e)
            return o.pre_loaded_vsj ? (stl_viewer.init_by_json(o.pre_loaded_vsj),
            o.pre_loaded_vsj = null,
            !0) : o.model_error("load_vsj - invalid filename" + e, o.load_error_callback);
    ...
    this.get_stl_bin = function(e) {
        ...
        if (t && t.mesh) {
            ...
            if (a) {
                for (var i = new ArrayBuffer(84 + 50 * a.faces.length), s = new DataView(i), n = (new TextEncoder,
                o.padend("Binary" + (t.colors ? " colored" : "") + " STL by viewstl.com", 80, " ")), l = 0; l < 80; l++)
                    s.setUint8(l, n.charCodeAt(l), !0);
                ...
                return Object.keys(a.faces).forEach(function(e) {
                    ...
                    s.setFloat32(r, _.x, !0),
                    r += 4,
                    s.setFloat32(r, _.y, !0),
                    r += 4,
                    s.setFloat32(r, _.z, !0),
                    r += 4,
                    s.setFloat32(r, n.x, !0),
                    r += 4,
                    s.setFloat32(r, n.y, !0),
                    r += 4,
                    s.setFloat32(r, n.z, !0),
                    r += 4,
                    s.setFloat32(r, l.x, !0),
                    r += 4,
                    s.setFloat32(r, l.y, !0),
                    r += 4,
                    s.setFloat32(r, l.z, !0),
                    r += 4,
                    s.setFloat32(r, d.x, !0),
                    r += 4,
                    s.setFloat32(r, d.y, !0),
                    r += 4,
                    s.setFloat32(r, d.z, !0),
                    r += 4,
                    t.colors ? s.setUint16(r, Math.ceil(31 * i.color.r) | Math.ceil(31 * i.color.g) << 5 | Math.ceil(31 * i.color.b) << 10, !0) : s.setUint16(r, 0, !0),
                    r += 2
                }),
                i
            }
    ...
    this.download_vsb = function(e) {
        ...
        try {
            ...
            return console.log("download_vsb - JSZip is missing ", e.message),
            !1
        }
        var a = o.get_vsb();
        t.file("json_data.vsj", o.json_without_nulls(a.vsj)),
        Object.keys(a.files).forEach(function(e) {
        ...
        t.generateAsync({
            ...
            s >= 0 && (i = i.substring(0, s)),
            i.length < 1 && (i = "1"),
            window.navigator.msSaveOrOpenBlob ? window.navigator.msSaveBlob(o, i + ".vsb") : (a.download = i + ".vsb",
            a.click())
        })
    }
    ,
    this.load_vsb = function(e) {
        if (o.pre_loaded_ab_files = [],
        o.pre_loaded_vsj = null,
        e instanceof File)
    ...
    this.read_bin_file = function(e, t, o, a) {
        ...
        i.onerror = function(e) {
            return console.log("reading file error", e),
            null
        }
        ,
        i.onload = function(e) {
    ...
    this.load_vsb_from_blob = function(e) {
        ...
        try {
            ...
            return console.log("load vsb - JSZip is missing ", e.message),
            !1
        }
    ...
    this.load_bin_to_ab_file = function(e, t) {
        o.pre_loaded_ab_files || (o.pre_loaded_ab_files = []),
        o.pre_loaded_ab_files[e] = t,
        o.add_model({
            id: -1,
            filename: e
        })
    ...
    this.download_model = function(e, t) {
        ...
        if (a && a.mesh) {
            ...
            l >= 0 && (n = n.substring(0, l)),
            n.length < 1 && (n = "1"),
            window.navigator.msSaveOrOpenBlob ? window.navigator.msSaveBlob(i, n + ".stl") : (s.download = n + ".stl",
            s.click())
        }
    }
    ,
    this.get_model_mesh = function(e) {
        ...
        if (t && t.mesh) {
            var a = t.mesh.clone();
            return a.geometry = t.mesh.geometry.clone(),
    ...
    this.do_model_animation = function(e) {
        if (e.animation) {
            var t = Date.now();
            if (e.animation.start_time || (e.animation.start_time = t),
            e.animation.delta) {
                ...
                if (o.animation_next_delta(e, e.animation.delta, i),
                a >= 1) {
            ...
            if (e.animation.exact) {
                ...
                if (o.animation_next_exact(e, e.animation.exact, i),
    ...
    this.animation_next_delta = function(e, t, a) {
        ...
        Object.keys(t).forEach(function(l) {
            ...
            case "z":
                i || (i = !0,
                o.set_position(e.id, e.x + (void 0 !== t.x ? t.x * a : 0), e.y + (void 0 !== t.y ? t.y * a : 0), e.z + (void 0 !== t.z ? t.z * a : 0)));
                break;
            case "rotationx":
            case "rotationy":
            case "rotationz":
                s || (s = !0,
                o.rotate(e.id, void 0 !== t.rotationx ? t.rotationx * a : 0, void 0 !== t.rotationy ? t.rotationy * a : 0, void 0 !== t.rotationz ? t.rotationz * a : 0));
                break;
            case "scale":
            case "scalex":
            case "scaley":
            case "scalez":
                ...
                o.set_scale(e.id, e.scalex + (void 0 !== t.scalex ? t.scalex * a : 0), e.scaley + (void 0 !== t.scaley ? t.scaley * a : 0), e.scalez + (void 0 !== t.scalez ? t.scalez * a : 0)))
            }
        })
    }
    ,
    this.animation_next_exact = function(e, t, a) {
        ...
        Object.keys(t).forEach(function(l) {
            ...
            case "z":
                ...
                o.set_position(e.id, e.x + (void 0 !== t.x ? t.xtotal * a : 0), e.y + (void 0 !== t.y ? t.ytotal * a : 0), e.z + (void 0 !== t.z ? t.ztotal * a : 0)));
                break;
            case "rotationx":
            case "rotationy":
            case "rotationz":
                if (!s) {
                    ...
                    o.rotate(e.id, void 0 !== t.rotationx ? t.rotxtotal * a : 0, void 0 !== t.rotationy ? t.rotytotal * a : 0, void 0 !== t.rotationz ? t.rotztotal * a : 0)
                }
                break;
            case "scale":
            case "scalex":
            ...
            case "scalez":
                ...
                o.set_scale(e.id, e.scalex + (void 0 !== t.scalex ? t.scalextotal * a : 0), e.scaley + (void 0 !== t.scaley ? t.scaleytotal * a : 0), e.scalez + (void 0 !== t.scalez ? t.scaleztotal * a : 0)))
            }
        })
    }
    ,
    this.remove_model_animation = function(e, t, a) {
        ...
        e.animation.delta || e.animation.exact || (e.animation = null,
        delete o.animation[e.id])
    }
    ,
    this.animate_model = function(e, t) {
        ...
        if (a) {
            if (!t)
                return o.remove_model_animation(a, !0, !0);
    ...
    this.init = function() {
        if (!o.init_done) {
            switch (o.WORLD_X_VECTOR = new THREE.Vector3(1,0,0),
            o.WORLD_Y_VECTOR = new THREE.Vector3(0,1,0),
            o.WORLD_Z_VECTOR = new THREE.Vector3(0,0,1),
            o.edges_material = new THREE.LineBasicMaterial({
                color: 0
            }),
            ...
            o.renderer = o.is_webgl ? new THREE.WebGLRenderer({
                preserveDrawingBuffer: !0,
                alpha: !0
            }) : new THREE.CanvasRenderer({
                alpha: !0
            }),
            o.camera = new THREE.PerspectiveCamera(45,1,.1,1e4),
            ...
            o.directionalLight = new THREE.DirectionalLight(16777215,.75),
            ...
            o.pointLight = new THREE.PointLight(16777215,.3),
    ...
    this.set_auto_resize = function(e) {
        o.do_resize && (window.removeEventListener("resize", o.do_resize),
    ...
    this.vf_to_geo = function(e, t, a) {
        ...
        var s = []
          ...
          , l = e.length;
        for (i = 0; i < l; i++)
            s.push(new THREE.Vector3(e[i][0],e[i][1],e[i][2]));
        l = t.length;
        if (a)
            for (i = 0; i < l; i++) {
                var r = new THREE.Face3(t[i][0],t[i][1],t[i][2]);
                r.color.setRGB(t[i][3], t[i][4], t[i][5]),
                n.push(r)
            }
        else
            for (i = 0; i < l; i++)
                n.push(new THREE.Face3(t[i][0],t[i][1],t[i][2]));
    ...
    this.set_geo_minmax = function(e) {
        ...
        if (t.boundingBox)
            ...
            for (var o = t.vertices, a = o[0].x, i = o[0].y, s = o[0].z, n = o[0].x, l = o[0].y, r = o[0].z, d = o.length; d--; )
                o[d].x < a && (a = o[d].x),
                o[d].y < i && (i = o[d].y),
                o[d].z < s && (s = o[d].z),
                o[d].x > n && (n = o[d].x),
    ...
    this.handleFileDrop = function(e) {
        e.stopPropagation(),
        e.preventDefault(),
        e.dataTransfer.files.length > 0 ? o.load_local_files(e.dataTransfer.files) : "string" == typeof e.dataTransfer.getData("Text") && (o.add_model({
            id: -1,
    ...
    this.clean = function() {
        if (o.scene) {
            ...
            for (i = e.children.length; i--; )
                "Mesh" === e.children[i].type && e.remove(e.children[i]);
            o.camera.position.set(o.camerax, o.cameray, o.cameraz),
            o.models = new Array,
            o.models_count = 0,
            o.models_ref = new Array,
            o.max_model_id = 0,
            o.load_status = new Array,
            o.load_session = 0,
            o.loaded_models_arr = new Array,
    ...
    this.external_files_loaded = function() {
        o.ready = !0,
        o.init(),
        o.ready_callback && o.ready_callback()
    }
    ,
    this.load_three = function(e) {
        "string" != typeof o.load_three_files && (o.load_three_files = ""),
        o.scripts_loader = new ScriptsLoader,
        o.scripts_loader.load_scripts(new Array(e + "three.min.js",e + "webgl_detector.js",e + "Projector.js",e + "CanvasRenderer.js",e + (0 == o.controls_type ? "OrbitControls.js" : "TrackballControls.js")), o.external_files_loaded)
    }
    ,
    ...
    o.set_options(),
    o.ready ? (o.init(),
    o.ready_callback && o.ready_callback()) : !1 !== o.load_three_files ? o.load_three(o.load_three_files) : o.model_error("No THREE files were loaded")
}
function ScriptsLoader() {
    ...
    this.scripts_are_loaded = function(t) {
        var o = Object.keys(t);
        for (i = o.length; i--; )
            if (!e.loaded_scripts[e.get_full_name(t[i])])
                return !1;
        return !0
    }
    ,
    ...
    this.load_files = function() {
        if (0 != e.scripts_to_load.length)
            ...
            e.all_loaded_callback && e.all_loaded_callback()
    }
}

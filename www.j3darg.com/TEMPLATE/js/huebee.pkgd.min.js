...
function(t, e) {
    ...
    o._bindStartEvent = function(e, n) {
        ...
        t.navigator.pointerEnabled ? e[i]("pointerdown", this) : t.navigator.msPointerEnabled ? e[i]("MSPointerDown", this) : (e[i]("mousedown", this),
        e[i]("touchstart", this))
    }
    ,
...
function(t, e) {
    ...
    function u(t, e, n) {
        ...
        e /= 255,
        n /= 255;
        var i, o = Math.max(t, e, n), s = Math.min(t, e, n), r = o - s, h = .5 * (o + s), a = 0 === r ? 0 : r / (1 - Math.abs(2 * h - 1));
    ...
    f.create = function() {
        ...
        n.className = "huebee ",
        n.className += this.options.staticOpen ? "is-static-open " : "is-hidden ",
        n.className += this.options.className || "";
        var i = this.container = document.createElement("div");
        if (i.className = "huebee__container",
    ...
    f.close = function() {
        this.isOpen && (w && this.hasTransition ? this.element.addEventListener("transitionend", this.onElemTransitionend) : this.remove(),
    ...
    "complete" == S || "interactive" == S ? o() : document.addEventListener("DOMContentLoaded", o),
    i.data = function(t) {
        t = h(t);
